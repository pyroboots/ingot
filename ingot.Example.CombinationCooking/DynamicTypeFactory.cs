...
/// <summary>
/// Emits empty marker types used as generic type arguments for <see cref="FoodItem{TToken}"/>
/// and <see cref="FoodRecipe{TToken}"/>.
/// </summary>
internal static class DynamicTypeFactory
{
    private static readonly AssemblyBuilder AssemblyBuilder = AssemblyBuilder.DefineDynamicAssembly(
        new AssemblyName("ingot.Example.CombinationCooking.Generated"),
    ...
    public static Type CreateToken(string nameHint)
    {
        ...
        // Type names must be unique and valid; keep the hint for debugging.
