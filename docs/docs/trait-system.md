...
By default this regenerates trait interfaces for **blocks**, **items**, and **entities** under:

- `ingot.Core/TraitSystem/Traits/Block/`
- `ingot.Core/TraitSystem/Traits/Item/`
- `ingot.Core/TraitSystem/Traits/Entity/` (including entity behaviour goals under `Entity/Behaviour/`)

Optional CLI arguments override the block and item output directories (args 0 and 1). You can also write custom traits by hand:
