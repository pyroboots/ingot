...
New traits are normally generated by running the generator against the official Microsoft docs pages (see `ingot.Generators`). You can also write custom traits by hand:
