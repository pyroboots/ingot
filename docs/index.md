...
See the [project README](https://github.com/pyroboots/ingot/blob/master/README.md) for installation, quick start, and project structure.
...
[API Reference](api/ingot.Core.html) | [Project Todo List](https://github.com/users/pyroboots/projects/4)