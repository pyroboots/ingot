...
// https://learn.microsoft.com/en-us/minecraft/creator/reference/content/entityreference/examples/entitygoals/minecraftbehavior_melee_box_attack?view=minecraft-bedrock-stable
...
/// </summary>
[Trait("minecraft:behavior.melee_box_attack", TraitSystem.TraitType.Entity)]
public interface IBehaviorMeleeBoxAttack : IEntityTrait
{
    /// <summary>
    ...
    /// </summary>
    [TraitProperty]
    public virtual float HorizontalReach => 0.800000011920929f;
