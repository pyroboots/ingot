...
// https://learn.microsoft.com/en-us/minecraft/creator/reference/content/entityreference/examples/entitygoals/minecraftbehavior_move_to_liquid?view=minecraft-bedrock-stable
...
/// </summary>
[Trait("minecraft:behavior.move_to_liquid", TraitSystem.TraitType.Entity)]
public interface IBehaviorMoveToLiquid : IEntityTrait
{
    [TraitProperty]
    ...
    /// </summary>
    [TraitProperty]
    public virtual dynamic MaterialType => null;
    ...
    /// <summary>
    /// Height in blocks the mob will look for the liquid block to move towards Value must be &gt; 0.
    /// </summary>
    [TraitProperty]
    public virtual int SearchHeight => 1;

    /// <summary>
    /// The distance in blocks it will look for the liquid block to move towards Value must be &gt; 0.
    /// </summary>
    [TraitProperty]
