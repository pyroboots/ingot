...
// https://learn.microsoft.com/en-us/minecraft/creator/reference/content/entityreference/examples/entitygoals/minecraftbehavior_inspect_bookshelf?view=minecraft-bedrock-stable
...
/// </summary>
[Trait("minecraft:behavior.inspect_bookshelf", TraitSystem.TraitType.Entity)]
public interface IBehaviorInspectBookshelf : IEntityTrait
{
    [TraitProperty]
    ...
    /// <summary>
    /// The height that the mob will search for bookshelves. Value must be &gt; 0.
    /// </summary>
    [TraitProperty]
    public virtual int SearchHeight => 1;

    /// <summary>
    /// The distance in blocks the mob will look for books to inspect. Value must be &gt; 0.
    /// </summary>
    [TraitProperty]
