...
// https://learn.microsoft.com/en-us/minecraft/creator/reference/content/entityreference/examples/entitygoals/minecraftbehavior_delayed_attack?view=minecraft-bedrock-stable
...
/// </summary>
[Trait("minecraft:behavior.delayed_attack", TraitSystem.TraitType.Entity)]
public interface IBehaviorDelayedAttack : IEntityTrait
{
    /// <summary>
    /// The entity's attack animation will play out over this duration (in seconds). Also controls attack cooldown.
    /// </summary>
    [TraitProperty]
    public virtual float AttackDuration => 0.75f;
    ...
    /// <summary>
    /// The percentage into the attack animation to apply the damage of the attack (1.0 = 100%). Value must be &lt;= 1.
    /// </summary>
    [TraitProperty]
    public virtual float HitDelayPct => 0.5f;
    ...
    /// </summary>
    [TraitProperty]
    public virtual float ReachMultiplier => 1.5f;
    ...
    /// </summary>
    [TraitProperty]
    public virtual bool TrackTarget => true;
