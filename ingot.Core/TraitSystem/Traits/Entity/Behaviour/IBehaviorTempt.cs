...
/// </summary>
[Trait("minecraft:behavior.tempt", TraitSystem.TraitType.Entity)]
public interface IBehaviorTempt : IEntityTrait
{
    /// <summary>
    ...
    /// <summary>
    /// Range of random ticks to wait between tempt sounds. Can be a number, an array [min, max], or an object with range_min/range_max or min/max.
    /// </summary>
    [TraitProperty]
