...
// https://learn.microsoft.com/en-us/minecraft/creator/reference/content/entityreference/examples/entitygoals/minecraftbehavior_move_to_land?view=minecraft-bedrock-stable
...
/// </summary>
[Trait("minecraft:behavior.move_to_land", TraitSystem.TraitType.Entity)]
public interface IBehaviorMoveToLand : IEntityTrait
{
    [TraitProperty]
    ...
    /// <summary>
    /// Height in blocks the mob will look for land to move towards Value must be &gt; 0.
    /// </summary>
    [TraitProperty]
    public virtual int SearchHeight => 1;

    /// <summary>
    /// The distance in blocks it will look for land to move towards Value must be &gt; 0.
    /// </summary>
    [TraitProperty]
