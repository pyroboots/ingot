...
public struct BlockEvents
{
    ...
    public (string jsonComponentName, string code) Compile(Identifier blockId)
    {
        ...
        {
            foreach (var module in CompilerState.CurrentPack.ScriptApiModules)
                sb.AppendLine($"import \"{module.Key}\"; // {module.Value.ToString()}");
        }
        else sb.AppendLine($"import \"@minecraft/server\";");
        sb.AppendLine();
